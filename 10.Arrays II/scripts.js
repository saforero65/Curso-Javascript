...
// console.log(numbers);
// numbers.splice(4); -Elimina despues de la posicion 4
// numbers.splice(2, 2); -Elimina desde la posicion 2 el numero de valores que se le indican
// numbers.splice(4, 0, 10, 23, 54); //-si b es un valor distinto de 0 elimina el numero de valores que indicquemos en b y añade los valores de items a partir de la posicion a
// console.log(numbers);
