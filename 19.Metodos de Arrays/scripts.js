...
//-----------------------------------------------------------------
// // FORM
// let word = "Hola JavaScript"
// console.log(Array.from(word))
// console.log(word.split(' '))
//------------------------------------------------------------------

// //SORT
// const letters = ['b', 'w', 'p', 'r']
// const numbers = [1, 6, 841, 318618, 3, 4, 864, 9]
...
// // FILTER
// const numbers = [1, 6, 841, 318618, 3, 4, 864, 9]
// const number2 = numbers.filter(number => (number > 4))
// console.log(number2)
// -------------------------------------------------------------
// FILTER
// const numbers = [1, 2, 3, 4, 5]
// const number2 = numbers.reduce((a, b) => a + b)
// console.log(number2)
